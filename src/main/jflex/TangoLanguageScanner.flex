...
%public
%class TangoLaguageTokenMarker
%extends AbstractJFlexCTokenMaker
%unicode
%type org.fife.ui.rsyntaxtextarea.Token

/**
 * Scanner for TangoLaguage.
 */
%{
    ...
    */
   public TangoLaguageTokenMarker() {
   }
...
SimpleFunctionCallFormat              = ({Identifier}[\(][\)])
...
<YYINITIAL> {
   ...
   "__PUBLISHED_EXPR__" |
   "__O_PE__"           |
   "__D_PE__"                                             { addToken(Token.RESERVED_WORD); }
   ...
   "return"   |
   "if"       |
   "while"                                                { addToken(Token.RESERVED_WORD_2); }
   ...
   "Tradable"   |
   "var"        |
   "Duration"                                             { addToken(Token.DATA_TYPE); }
   {BooleanLiteral}                                       { addToken(Token.LITERAL_BOOLEAN); }

   /* Functions */
   //{SimpleFunctionCallFormat}                             { addToken(Token.FUNCTION); }
