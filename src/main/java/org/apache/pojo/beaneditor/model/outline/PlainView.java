...
public class PlainView extends View implements TabExpander {
    ...
    /**
     * Gives access to a buffer that can be used to fetch text from the
     * associated document.
     *
     * @return the buffer
     */
    ...
    public void paint(Graphics g, Shape a) {
        ...
        for (int line = linesAbove; line < endLine; line++) {
            if (dh != null) {
                ...
                if (line == lineCount) {
                    dh.paintLayeredHighlights(g, lineElement.getStartOffset(), lineElement.getEndOffset(), originalA,
                            host, this);
                } else {
